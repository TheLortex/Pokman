...
public class CreditActivity extends SimpleBaseGameActivity {
	...
	protected Scene onCreateScene() {
		...
		devText2.setX(MenuActivity.SCREENWIDTH - 20 - devText2.getWidth());
		scene.attachChild(devText2);
		
		Text sfxText1 = new Text(15,500,mFont26,"Thanks Rémi Dupré who let",this.getVertexBufferObjectManager());
		...
		Rectangle touchListener = new Rectangle(0,0,MenuActivity.SCREENWIDTH, MenuActivity.SCREENHEIGHT,this.getVertexBufferObjectManager()) {
			@Override
