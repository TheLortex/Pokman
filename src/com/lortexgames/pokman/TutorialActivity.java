...
public class TutorialActivity  extends SimpleBaseGameActivity  implements SensorEventListener{
	...
	protected Scene onCreateScene() {
		...
		drawStep1(0);
		drawStep2(MenuActivity.SCREENWIDTH);
		drawStep3(MenuActivity.SCREENWIDTH*2);
		drawStep4(MenuActivity.SCREENWIDTH*3);
		drawStep5(MenuActivity.SCREENWIDTH*4);
		...
		mScene.setOnSceneTouchListener(new IOnSceneTouchListener() {
			...
			public boolean onSceneTouchEvent(Scene pScene, TouchEvent pSceneTouchEvent) {
				...
				if(pSceneTouchEvent.isActionDown()) {
					...
					for(int i=1;i<=nPages;i++) {
						if(mCamera.getCenterX() < MenuActivity.SCREENWIDTH*i) {
							mCamera.setCenter(MenuActivity.SCREENWIDTH/2f, MenuActivity.SCREENHEIGHT/2f);
							mCamera.offsetCenter((i-1)*MenuActivity.SCREENWIDTH, 0);
							pagination.setX((i-1)*MenuActivity.SCREENWIDTH);
							currentPage=i;
							i=nPages+1;
						}
					}
					
					if(mCamera.getCenterX()>MenuActivity.SCREENWIDTH*nPages) {
						mCamera.setCenter(MenuActivity.SCREENWIDTH/2f, MenuActivity.SCREENHEIGHT/2f);
						mCamera.offsetCenter((nPages-1)*MenuActivity.SCREENWIDTH, 0);
						pagination.setX((nPages-1)*MenuActivity.SCREENWIDTH);
					}
					updateGravity();
			...
			public void postSolve(Contact contact, ContactImpulse impulse) {
				...
				if(((bodyA == ghostBodies.get(0))||(bodyB ==  ghostBodies.get(0)))&&((bodyA == pacmanBodies.get(2))||(bodyB ==  pacmanBodies.get(2)))) {
					runOnUiThread(new Runnable() {
						@Override
						public void run() {
							pacmanSprites.get(2).detachSelf();
							pacmanBodies.get(2).setActive(false);
		...
		pagination = new Paginator(20, MenuActivity.SCREENHEIGHT-20, MenuActivity.SCREENWIDTH-40, 15, 5, 1, this.getVertexBufferObjectManager());
	...
	private void drawStep1(int offsetX) {
		...
		title.setX(offsetX+MenuActivity.SCREENWIDTH/2f-title.getWidth()/2f);
		...
		text1.setX(offsetX+MenuActivity.SCREENWIDTH/2f-text1.getWidth()/2f);
		text1.setY(MenuActivity.SCREENHEIGHT-200);
		...
		text2.setX(offsetX+MenuActivity.SCREENWIDTH/2f-text2.getWidth()/2f);
		text2.setY(MenuActivity.SCREENHEIGHT-150);
	...
	private void drawStep5(int offsetX) {
		...
		playText.setX(offsetX+MenuActivity.SCREENWIDTH/2f-playText.getWidth()/2f);
		playText.setY(MenuActivity.SCREENHEIGHT/2f-playText.getHeight()/2f);
	...
	private void drawMaze(int page) {
		int mazeWidth = 7*40;
		int offsetX = (int) (MenuActivity.SCREENWIDTH*(page-1) + MenuActivity.SCREENWIDTH/2f - mazeWidth/2f);
		int offsetY = 400;
