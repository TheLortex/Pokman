...
public class TextureHandler {
	...
	public void load(String name, final String path) {
		try {
			ITexture texture;
			texture = new BitmapTexture(mContext.getTextureManager(),new IInputStreamOpener() { @Override public InputStream open() throws IOException {return mContext.getAssets().open(path);}}, TextureOptions.BILINEAR);
			texture.load();
